...
# Final Version (v4): Kết hợp System Prompt hiệu quả của v2 và Few-Shot chất lượng của v3.
...
OUTPUT_CSV = "./fixed-vihallu-public-test_final_4.csv" # Đổi tên file output cuối cùng
COLUMNS_TO_FIX = ['context', 'prompt', 'response']

# *** LẤY FEW-SHOT TỐT NHẤT TỪ VER 3 ***
FEW_SHOT = [
...
# --- CÁC NGƯỠNG LỌC ĐƯỢC SIẾT CHẶT ĐỂ ĐẢM BẢO AN TOÀN TỐI ĐA ---
WORD_COUNT_TOLERANCE = 2
ACCEPT_SIMILARITY_THRESHOLD = 0.92 
LENGTH_CHANGE_ALLOWED_RATIO = 0.15
STRICT_BASE_SIMILARITY = 0.90
LENIENT_BASE_SIMILARITY = 0.90

# debug outputs
correction_cache = {}
DEBUG_LOG_CSV = "debug_corrections_final_4.csv"
SAMPLE_DEBUG_N = 20
...
print("FEW SHOT LEARNING EXMAPLES")
...
def make_correction_prompt_llama2(original_text):
    """
    *** LẤY SYSTEM PROMPT HIỆU QUẢ NHẤT TỪ VER 2 ***
    """
